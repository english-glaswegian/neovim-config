...
local mappings = {
  ...
  r = {
    ...
    m = {
      name = "Move",
      a = { "<cmd>RustMoveItemDown<cr>", "Move Item Up" },
      r = { "<cmd>RustMoveItemUp<cr>", "Move Item Down" },
    },
    s = { "<cmd>RustStartStandaloneServerForBuffer<cr>", "Start Standalone Server for Buffer" },
